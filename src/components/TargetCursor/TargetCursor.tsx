...
const TargetCursor = ({
    ...
    useEffect(() => {
        ...
        console.log("[mount] TargetCursor mounted", { initialX, initialY })
        ...
        const enterHandler = (e: MouseEvent) => {
            ...
            if (!target || !cursorRef.current || !cornersRef.current) {
                console.log("[3] enterHandler bail - no target", { directTarget: directTarget?.tagName, hasCursor: !!cursorRef.current })
                return
            }
            if (activeTarget === target) {
                console.log("[3] enterHandler bail - already active on this target")
                return
            }
            console.log("[3] corners EXPAND on target", target.id || target.className)
            if (activeTarget) {
